...
\begin{document}
  ...
  \begin{enumerate}
    \item Open a terminal and download the lab package: \okt{rosdl ecn_manip}.
    \item Run Qt Creator from the top screen icon
    \item Load the \okt{ros/src/ecn_manip/CMakeLists.txt} file through \okt{File...open project}
    \item QtCreator asks for a compilation folder: give \okt{ros/build/ecn_manip}
